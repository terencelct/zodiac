...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      br(),
      selectInput("zodiac","3.Select zodiac to compare with dragon effect",choices=c("Dragon"=5,"Rat"= 1,"Ox"=2,"Tiger"=3,"Rabbit"=4,"Snake"=6,"Horse"=7,"Sheep"=8,"Monkey"=9,"Rooster"=10,"Dog"=11,"Pig"=12), selected = "Dragon"),
      br(),
